...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <div className="sm:hidden border-t border-[#8b8b8b] sm:mt-20 mt-10 py-4 px-4 flex flex-col gap-4">
      ...
      <div className="hidden border-t border-[rgb(139,139,139)] sm:mt-20 mt-10 py-10 px-4 sm:flex flex-row gap-4">
